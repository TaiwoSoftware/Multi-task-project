export default function Inputs({labelFor, labelText, type, value, handleChange, innerText}) {
  return (
    ...
    <>
        ...
        <input type={type} value={value} onChange={handleChange} className="  border w-[254px] p-4 outline-orange-800 rounded-[10px] h-[40px] mt-2 border-gray-600 block" required id={labelFor} placeholder={innerText}/>
    </>
  )
}
